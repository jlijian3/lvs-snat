...
#define IP_VS_SO_SET_ADDLADDR_ZONE	(IP_VS_BASE_CTL+20)
#define IP_VS_SO_SET_DELLADDR_ZONE	(IP_VS_BASE_CTL+21)
...
#define IP_VS_SO_GET_LADDRS_ZONE (IP_VS_BASE_CTL+11)
